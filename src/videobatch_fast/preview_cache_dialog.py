...
def show_preview_cache_dialog(parent) -> Toplevel:
    """Show a small user-facing cache status and safe cleanup surface."""
    ...
    hint.grid(row=9, column=0, columnspan=2, sticky="ew", pady=(0, 14))
    ...
    def clear_cache() -> None:
        confirmed = messagebox.askyesno(
            ...
            (
                ...
                "Originalmedien, Projekte und fremde Dateien bleiben unverändert. "
                "Fortfahren?"
            ),
            parent=window,
        )
