...
from .ui_workspace_shell_layout_mixin import UiWorkspaceShellLayoutMixin
from .workflow_grid import normalize_workflow_layout_mode

LEGACY_WORKSPACE_CONTRACT_KEY = "ui.workspace_grid.mittiger_hauptarbeitsbereich_flexibles_22_raster"


class UiWorkspaceGridMixin(UiWorkspaceShellLayoutMixin):
